...
Endpoint: GET /v1/debt-collection/{debtCollectionRunId}/details
Version: 1.9.0
Security: ApiKeyAuth
...
## Response 200 fields (application/json):
  ...
  - `status` (string)
    ...
    Enum: "INTERNAL_PROCESSING", "WAITING_FOR_CONFIRMATION", "COMPLETED", "FAILED"

  - `origin` (string)
    Origin of debt collection
    Enum: "DEBT_COLLECTION_RUN", "INDIVIDUAL_HANDOVER", "AUTOMATIC_HANDOVER", "CONTRACT_CANCELATION"
