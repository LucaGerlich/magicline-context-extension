...
Endpoint: POST /v1/memberships/{contractId}/self-service/additional-modules/validate
Version: 1.9.0
Security: ApiKeyAuth
...
## Request fields (application/json):
  ...
  - `additionalModuleId` (integer, required)
  ...
  - `bookTrialPeriod` (boolean, required)
...
## Response 200 fields (application/json):
  ...
  - `validationStatus` (string, required)
    ...
    Enum: "ADDITIONAL_MODULE_CONTRACT_ALREADY_PURCHASED", "ADDITIONAL_MODULE_CONTRACT_INVALID_STATUS", "ADDITIONAL_MODULE_NOT_FOUND", "ADDITIONAL_MODULE_NOT_ONLINE_PURCHASABLE", "ADDITIONAL_MODULE_TRIAL_PERIOD_NOT_BOOKABLE", "ADDITIONAL_MODULE_PURCHASABLE"
