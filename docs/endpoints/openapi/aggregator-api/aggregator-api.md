...
[Aggregator API](https://redocly.sportalliance.com/_spec/apis/magicline/aggregator/aggregator.yaml)

## Other

### Create aggregator member

 - [POST /v1/aggregators/member](https://redocly.sportalliance.com/apis/magicline/aggregator/aggregator/other/createaggregatormember.md): Required Scopes: 
...
Endpoint: POST /v1/aggregators/member
Security: ApiKeyAuth
