...
To use this context with `gemini-cli`, you can point the tool to the `GEMINI.md` file or include the repository's content in your prompt context to provide the AI with the necessary domain knowledge.